...
# Abalone Data Set
# ===============================================
# download data file to working directory
...
# download data file to working directory
uci <- 'http://archive.ics.uci.edu/ml/machine-learning-databases/'
bridges <- 'bridges/bridges.data.version1'
url <- paste0(uci, bridges)
download.file(url, destfile = 'bridges.csv')
...
mean(bridges1$LENGTH, na.rm = TRUE)
