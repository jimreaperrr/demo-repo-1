...
### Regular Expressions
  ...
  * `stringr()` package functions:
    - str_detect(): *detects* what elements contain a match to the specified pattern:
      - str_detect(string = something, pattern = "something")
    - str_extract(): pattern extraction:
      - str_extract(string = something, pattern = "something")
    - str_replace(): replace a pattern with a new string:
      - str_replace(string = something, pattern = "something", replacement = "replacement")
    - str_split():
      - str_split(string = something, pattern = "something")
